...
<div class="container align-bottom blue-grey-text text-lighten-1">
    <div class="row">
        <div class="col s4"><h4>Venue Audit</h4></div>
        <div class="col s2"><h5>Unit Audit score</h5></div>        
        <div class="col s2"><h5><i>the score goes here</i></h5></div>
        <div class="col s2"><h5>Admin Audit score</h5></div>        
        <div class="col s2"><h5><i>the score goes here</i></h5></div>
    </div>
</div>
