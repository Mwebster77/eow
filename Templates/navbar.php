<!-- Main Nav Bar Code -->	
<style>
		/* changes the dropdown menu colour */
...
<nav class="blue-grey lighten-1 z-depth-0">
	<div class="container">
		<div class="nav-wrapper">
		  <ul class="left hide-on-med-and-down">
			...
			<li><a class="dropdown-trigger" href="#!" data-target="audit"><i class="material-icons left">content_paste</i>Audit</a></li>
	...
	<!--        <li><a href="../eow/files/add.php"><i class="material-icons left">school</i>Testing</a></li>		  -->
		  </ul>
...
<!-- Liquor Dropdown Structure -->
<ul id="liquor" class="dropdown-content">
	<li><a href="#"><i class="material-icons left">content_paste</i>Stocktaking</a></li>		  
	<li><a href="#"><i class="material-icons left" >local_shipping</i>Deliveries</a></li>
	<li><a href="#"><i class="material-icons left">shopping_basket</i>Orders</a></li>
</ul>

<ul id="liquorSide" class="dropdown-content">
	<li><a href="#"><i class="material-icons left">content_paste</i>Stocktaking</a></li>		  
	<li><a href="#"><i class="material-icons left" >local_shipping</i>Deliveries</a></li>
	<li><a href="#"><i class="material-icons left">shopping_basket</i>Orders</a></li>
</ul>
...
<ul id="audit" class="dropdown-content">
	<li><a href="../pages/venueAudit.php"><i class="material-icons left">content_paste</i>Venue Audit</a></li>		  
	<li><a href="#"><i class="material-icons left" >monetization_on</i>Safe Check</a></li>
</ul>

<ul id="auditSide" class="dropdown-content">
	<li><a href="../pages/venueAudit.php"><i class="material-icons left">content_paste</i>Venue Audit</a></li>		  
	<li><a href="#"><i class="material-icons left" >monetization_on</i>Safe Check</a></li>
</ul>
<!-- ---------------------------------------------------------------------------------------------------------------------------------------- -->
